...
const aboutContent = "Trunki is a fun and interactive learning app for kids. Our mission is to make learning joyful and engaging through playful games, stories, and activities.";
const blogPosts = [
...
const faqs = [
  { question: "What age group is Trunki for?", answer: "Trunki is designed for children aged 4-10." },
  { question: "Can I use Trunki offline?", answer: "Yes! Many features work offline." },
  { question: "Is it safe for kids?", answer: "Absolutely! No ads or unsafe content." },
];
...
const LandingPage = () => {
  return (
    <div className="min-h-screen w-full bg-pink-600 relative overflow-x-hidden scroll-smooth">
      ...
      {/* Hero Section */}
      <section id="home" className="min-h-screen flex flex-col md:flex-row items-center justify-center px-6 md:px-20 pt-24 md:pt-32 relative z-10">
        {/* Video Section */}
  ...
  />
        ...
        <div className="text-center md:text-left md:w-1/2 fade-in z-10">
          ...
          <p className="text-white mb-8 max-w-lg text-xl md:text-2xl animate-fadeIn delay-150">
            Fun learning games and activities that make your child happy and smart.
          </p>
          <button className="bg-yellow-400 hover:bg-yellow-500 text-gray-800 font-bold px-8 py-4 rounded-full shadow-xl text-xl md:text-2xl transition transform hover:scale-105 animate-fadeIn delay-300">
            Get Started
          </button>
        </div>
      </section>
      ...
      <section id="about" className="w-full py-20 bg-white relative z-10">
        <h2 className="text-4xl md:text-5xl font-extrabold text-center text-pink-600 mb-12">About Trunki</h2>
      ...
      <section id="blog" className="w-full py-20 bg-pink-200 relative z-10">
        <h2 className="text-4xl md:text-5xl font-extrabold text-center text-pink-600 mb-12">Blog</h2>
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 px-6">
          {blogPosts.map((post, index) => (
            <div key={index} className="bg-white rounded-3xl p-6 shadow-lg hover:shadow-2xl transition transform hover:scale-105 text-center">
      ...
      <section id="faq" className="w-full py-20 bg-white relative z-10">
        <h2 className="text-4xl md:text-5xl font-extrabold text-center text-pink-600 mb-12">FAQ</h2>
      ...
      {/* Contacts Section */}
      <section id="contacts" className="w-full py-20 bg-pink-600 relative z-10 text-white">
        <h2 className="text-4xl md:text-5xl font-extrabold text-center mb-12">Contact Us</h2>
