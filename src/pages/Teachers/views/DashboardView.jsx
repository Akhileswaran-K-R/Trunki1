  ...
  return (
    <div className="p-6">
      ...
      <div className="bg-white rounded-xl shadow p-6 mb-8">
        <h2 className="text-xl font-bold mb-4 text-gray-800">Recent Students</h2>
      ...
      <div className="bg-white rounded-xl shadow p-6 mb-8">
        <div className="flex flex-col mb-4">
          <h2 className="text-xl font-bold text-gray-800">Student Risk Distribution</h2>
          <p className="text-sm text-gray-500">Overview of academic standing across all classes</p>
        </div>
